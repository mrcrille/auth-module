        ...
        <b-card bg-variant="light">
          ...
          <form @keydown.enter="login">
            <b-form-group label="Username">
              <b-input v-model="username" placeholder="Username" ref="username"/>
            </b-form-group>
            ...
            <div class="text-center">
              <b-btn @click="login" variant="primary">Login</b-btn>
              <b-btn
                @click="loginFirebase"
                style="background: #ec5425"
                class="login-button"
              >Login with Firebase</b-btn>
            </div>
          </form>
        </b-card>
      </b-col>
